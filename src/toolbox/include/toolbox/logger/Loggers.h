...
#ifndef TOOLBOX_LOGGERS_H_
#define TOOLBOX_LOGGERS_H_
...
public:
    ...
    void
    logMessage(const char* msg, LogType lt) override
    {
        // this should match to the toolbox::LogType
